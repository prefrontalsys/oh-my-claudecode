...
> **注意：包命名** — 项目品牌名为 **oh-my-claudecode**（仓库、插件、命令），但 npm 包以 [`oh-my-claudecode`](https://www.npmjs.com/package/oh-my-claudecode) 发布。通过 npm/bun 安装 CLI 工具时，请使用 `npm install -g oh-my-claudecode`。
